...
#-------------------------------------------------------------------------------------------
# Change TARGET and LINUX_ARCH to whatever you need. This example was
# compiled with the target as V850 and x86_64. To get the LINUX_ARCH, you can
# run uname -m in the command line. GCC/BINUTILS/MPFR, etc are latest as of 9/28/2022, but check to see any update
#-------------------------------------------------------------------------------------------
...
LINUX_KERNEL_VERSION=linux-5.16.9
GLIBC_VERSION=glibc-2.35
